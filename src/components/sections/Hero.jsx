      ...
      <div className="container mx-auto px-6 md:px-12 grid lg:grid-cols-2 gap-12 items-center z-10">
        <div className="flex flex-col gap-6 reveal max-w-2xl">
          ...
          <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-xl">
            ...
            จนกระทั่งได้พบกับความหลงใหลในโลกแห่งการเขียนโค้ด ผ่านบูทแคมป์ JSD12
            วันนี้ฉัน คือ Full-Stack Developer ที่พร้อมนำความเข้าใจใน "User
            Insight" มาพัฒนาเว็บแอปพลิเคชันด้วยเครื่องมือที่ทันสมัย (MERN Stack)
            เพื่อเปลี่ยนไอเดียให้กลายเป็นโปรดักส์ที่ทำงานได้จริง
          </p>
          ...
          <div className="flex flex-wrap items-center gap-4 mt-4">
            ...
            <a
              href="https://drive.google.com/file/d/1Y41Q8ivITvHG4OY-thDXieKHj5eTBRzf/view?usp=drive_link"
              download
